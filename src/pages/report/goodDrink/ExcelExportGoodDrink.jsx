...
class ExcelExportGoodDrink extends React.Component {
  exportToExcel = () => {
    ...
    this.saveAsExcelFile(excelBuffer, 'report-good-drink');
...
export default ExcelExportGoodDrink;
